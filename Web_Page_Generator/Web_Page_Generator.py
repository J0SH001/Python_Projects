...
class ParentWindow(Frame):
    def __init__(self, master):
        ...
        self.btn.grid(row=1, column=2, padx=(10,10), pady=(10, 10))

        self.customText = Entry(width=75)
        self.customText.grid(row=0, column=0, columnspan=4, padx = (10,10), pady = (10,10))
